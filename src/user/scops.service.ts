...
export class ScopesService {
     ...
     */
    async createScope(createScopeDto: CreateScopeDto, organization: string): Promise<any> {
     ...
     */
    async updateScope(scopeId: string, updateScopeDto: UpdateScopeDto): Promise<any> {
